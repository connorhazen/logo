...
so that information must flow through multiple channels rather than a Model View design. The model view design will not 
...
One of our biggest design challenges was how to create the flow communication between the View and the Controller. Our 
